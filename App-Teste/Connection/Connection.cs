...
namespace App_Teste.Connection
{
    public class Connection
    {
        ...
        public static SQLiteConnection connectionSLite(string name)
        {
        ...
        public static SQLiteDataReader reader(String parameter, string name)
        {
            ...
            try
            {
                using var cmd = connectionSLite(name).CreateCommand();
        ...
        public static SQLiteDataReader GetDatas(String parameter, string name)
        {
            using (var cmd = connectionSLite(name).CreateCommand())
            {
        ...
        public static List<string> readerDN(string nome, string classe_pressao, string name)
        {
            SQLiteDataReader reader = null;
